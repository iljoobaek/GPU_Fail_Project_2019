...
int main() {
    ...
    cudaMalloc(&d_m, (no_el-1)*sizeof(int));
    ...
    cudaMemcpy(d_m, h_m, (no_el-1)*sizeof(int), cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(h_z, d_z, no_el*sizeof(int), cudaMemcpyDeviceToHost);
